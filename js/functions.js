  ...
  .done(function(data) {
    ...
    if (result.status == "ok") {
      ...
      $.each(result.national, function (i, value) {
        ...
        output+= "<image src='images/" + value.image + "' border='0' width='80'> <b style='color:#FFFFFF;'>" + value.name + " " + value.total + "%</b> <i>" + value.votes + " votes</i><br>";
      ...
      $.each(result.states, function (i, value) {
        ...
        $.each(value.results, function (j, value2) {        
          ...
          output+= "<div class='col'>";
          output+= "<image src='images/" + value2.image + "' border='0' width='32'> <b style='color:#FFFFFF;'>" + value2.name + " " + value2.total + "%</b> <i>" + value2.votes + " votes</i><br>";
      ...
      var output = "<h1 class='text-center'>No votes found!</h1>";
    }
